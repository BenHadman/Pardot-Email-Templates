...
var app = __webpack_require__("./source/_layouts/default/assets/js/app.js");
...
/***/ "./source/_layouts/default/assets/js/app.js":
/***/ (function(module, exports, __webpack_require__) {

var helpers = __webpack_require__("./source/_layouts/default/assets/js/helpers.js").default;
...
module.exports.boot = function () {
  ...
  var tocLinks = anchors.elements.filter(function (el) {
    return ['H2'].indexOf(el.tagName) > -1;
  }).map(function (el) {
    return {
  ...
  var tocWrapper = document.querySelector('.quickies');
  if (tocWrapper && tocLinks.length < 1) {
    tocWrapper.previousElementSibling.remove();
  }
  var tocLinksHTML = tocLinks.map(function (el) {
    var pl = el.isChild ? ' pl-2' : '';
    el = '<li class="mb-3' + pl + '">' + '<a href="' + el.href + '" class="quickie scroll-to hover:text-grey-darkest">' + el.text + '</a>' + '</li>';
   ...
   */
  var collapseables = document.querySelectorAll('.toggle-trigger, .filetree a');
  ...
  function onTabClick(e) {
    ...
    var otherLinks = helpers.getSiblings(e.target.parentNode);
    var otherPanels = helpers.getSiblings(document.getElementById(e.target.href.split('#')[1]));
    var siblings = otherLinks.concat(otherPanels);

    // deactivate existing active tab and panel
    for (var _i = 0; _i < siblings.length; _i++) {
      siblings[_i].classList.remove('active');
      siblings[_i].setAttribute('aria-expanded', 'false');
    }

    // activate new tab
    e.target.parentNode.classList.add('active');
    // activate new panel
    var panel = document.getElementById(e.target.href.split('#')[1]);
    panel.getAttribute('aria-expanded') == 'true' ? panel.setAttribute('aria-expanded', 'false') : panel.setAttribute('aria-expanded', 'true');
  }

  var tabLinks = document.querySelectorAll('.tabs a');
  for (var _i2 = 0; _i2 < tabLinks.length; _i2++) {
    tabLinks[_i2].addEventListener('click', onTabClick, false);
  }
  ...
  function addScrollTo(e) {
    ...
    var offset = null !== e.target.getAttribute('data-offset') ? parseInt(e.target.getAttribute('data-offset'), 10) : -100;

    if (!e.target.classList.contains('scroll-to')) return;
   ...
   */
  var codeBlocks = [].slice.call(document.querySelectorAll('pre'));
  ...
  var clipboard = new ClipboardJS('.copy-to-clipboard', {
    target: function target(_target) {
      return _target.previousElementSibling.firstChild;
    }
  });
  ...
  function togglePreview(e) {
    var button = e.target;
    var previewType = button.getAttribute('data-preview');
    var iframe = button.parentElement.nextElementSibling;
...
/***/ "./source/_layouts/default/assets/js/helpers.js":
 ...
 */
var Helpers = {
  getHeadingText: function getHeadingText(el) {
    var text = '';
